...
{
	int16_t value = analogRead(0);  // analogpin for keypad

#define _BUTTON_analog_enter_min     700     // Button Enter
#define _BUTTON_analog_enter_max     790  
#define _BUTTON_analog_up_min        100     // Button Up
#define _BUTTON_analog_up_max        195   
#define _BUTTON_analog_down_min      300     // Button Down
#define _BUTTON_analog_down_max      380   
	//optional if menu element "back" exists, look at FUNC_back in functions tab 
#define _BUTTON_analog_enable_quit   0
#define _BUTTON_analog_back_min      950     // Button Back
#define _BUTTON_analog_back_max      1020   
	//optional if needed
#define _BUTTON_analog_enable_lr     1
#define _BUTTON_analog_left_min      400     // Button Left
#define _BUTTON_analog_left_max      555   
#define _BUTTON_analog_right_min     0     // Button Right
